...
export const projects = [
  ...
  },
  {
    ...
    group: "support",
    summary:
      "Ferramenta pública para agilizar e padronizar textos técnicos destinados ao atendimento presencial.",
    problem:
      "O encaminhamento de chamados exigia textos repetitivos, organização manual das informações e atenção constante para não omitir dados importantes.",
    solution:
      "Um formulário que valida os campos, organiza as informações, gera o texto automaticamente, permite copiar o resultado e mantém rascunhos e histórico no navegador.",
    result:
      "A ferramenta oferece um fluxo único para preparar encaminhamentos consistentes e consultar ou excluir registros armazenados localmente.",
    ...
    highlights: [
      "Validação dos campos antes da geração",
      "Geração automática e cópia do texto",
      "Rascunho mantido no navegador",
      "Histórico local com exclusão de registros",
    ],
    challenges: [
      "Transformar diferentes informações do chamado em um texto previsível e fácil de revisar.",
      "Manter rascunhos e histórico sem depender de um serviço de banco de dados.",
    ],
    learnings: [
      "Validação de formulários e manipulação do DOM com JavaScript.",
